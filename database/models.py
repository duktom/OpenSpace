...
class Account(Base):
    ...
    # e.g. "user" (historical values might exist; keep nullable)
    ...
    # relationships (1:1 Account -> User)
    user = relationship(
        "User",
...
class User(Base):
    # IMPORTANT: Postgres reserved keyword handling
    # Physical table name is exactly: "User"
    __tablename__ = "User"
